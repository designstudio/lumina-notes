...
export function canToggleList(
  ...
  if (!turnInto) {
    switch (type) {
      ...
      case "taskList":
        return can.toggleList("taskList", "taskItem")
      default:
        return false
    }
  }
  ...
  switch (type) {
    case "bulletList":
      return can.toggleBulletList() || can.clearNodes()
    case "orderedList":
      return can.toggleOrderedList() || can.clearNodes()
    case "taskList":
      return can.toggleList("taskList", "taskItem") || can.clearNodes()
    default:
      return false
  }
}
...
export function isListActive(editor: Editor | null, type: ListType): boolean {
  ...
  switch (type) {
    case "bulletList":
      return safeIsActive(editor, "bulletList")
    case "orderedList":
      return safeIsActive(editor, "orderedList")
    case "taskList":
      return safeIsActive(editor, "taskList")
    default:
      return false
  }
}
