...
export function canToggle(
  ...
  return level
    ? can.setNode("heading", { level }) || can.clearNodes()
    : can.setNode("heading") || can.clearNodes()
}
...
export function isHeadingActive(
  ...
  if (Array.isArray(level)) {
    return level.some((l) => safeIsActive(editor, "heading", { level: l }))
  }

  return level
    ? safeIsActive(editor, "heading", { level })
    : safeIsActive(editor, "heading")
}
...
export function toggleHeading(
  ...
  try {
    ...
    const isActive = levels.some((l) =>
      safeIsActive(editor, "heading", { level: l })
    )
