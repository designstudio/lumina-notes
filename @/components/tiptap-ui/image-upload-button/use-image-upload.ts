...
// --- Lib ---
import { isExtensionAvailable, isEditorUsable, safeCan, safeIsActive } from "@/lib/tiptap-utils"
...
export function canInsertImage(editor: Editor | null): boolean {
  ...
  return can ? can.insertContent({ type: "imageUpload" }) : false
}
...
export function isImageActive(editor: Editor | null): boolean {
  if (!isEditorUsable(editor)) return false
  return safeIsActive(editor, "imageUpload")
}
